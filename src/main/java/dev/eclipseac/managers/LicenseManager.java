...
public class LicenseManager {
    ...
    private static final String SERVER_URL = "https://73a0c01b-8076-4044-bf03-66dcaa5d613e-00-1nn52hx2zd3n7.picard.replit.dev:3000";
    ...
    public boolean validate() {
        ...
        try {
            String checkUrl = SERVER_URL.replaceAll("/$", "") + "/check/" + key;
